  ...
  return (
    <div className=" group relative z-0 pb-6 sm:pl-6">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="absolute right-0 mr-8 hidden w-fit cursor-pointer items-center gap-x-2 rounded-md bg-skin-inverted p-1 px-3 py-1 font-semibold capitalize text-skin-inverted  no-underline hover:bg-skin-inverted/90 group-hover:flex sm:px-4 sm:py-2 "
      >
     ...
     prose-a:border-skin-base prose-a:text-skin-base prose-a:no-underline hover:prose-a:border-accent
     prose-strong:text-skin-base prose-code:text-skin-base prose-pre:border prose-pre:border-skin-base 
     prose-pre:bg-skin-base 
     prose-pre:text-skin-muted
     prose-ol:text-accent prose-ul:text-skin-muted
     prose-li:text-skin-base
     prose-li:before:bg-accent
     "
      >
